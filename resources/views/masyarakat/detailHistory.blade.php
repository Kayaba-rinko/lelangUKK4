            ...
            <div class="bid-info">
                ...
                <div class="bid-meta">
                    ...
                    <div class="meta-box">
                        ...
                        <p class="meta-value" style="font-weight:bold;color: {{ $isWinner ? '#3dbf33' : '#d9534f' }}">{{ $proses ? 'PENDING' : ($isWinner ? 'MENANG' : 'KALAH') }}
                        </p>
                    </div>
                    <div class="meta-box">
                        <small>Status Lelang</small>
                        <p class="meta-value" style="font-weight:bold;color: {{ $proses ? '#ff0018' : '#5555ff' }}">{{ $proses ? 'PROSES' : 'DITUTUP' }}
                        </p>
                    </div>
                </div>
                <div class="your-bid-box" style="margin-top:20px;">
                    <small>Penawaran Anda</small>
                    <p class="meta-value" style="font-size:18px;font-weight:bold;">
                        Rp {{ number_format($bidKamu->penawaran_harga) }}
                    </p>
                </div>
